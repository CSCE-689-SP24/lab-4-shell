# File generated by xdc_sorter v3.3 (Wed Apr 24 06:40:07 CDT 2024)
...
create_clock -name CLK_design_part_NoSLR_zkprctrl_wrapper_fib_bridge_rx_u_xst_wrapper_0_socket_lvds_sys_slave_0_u_xst_wrapper_0_socket_lvds_gp_in_0_u_xst_wrapper_0_clki_dv -period [expr [expr 10.00/3]*3] [get_pins {design/part_NoSLR/zkprctrl/wrapper/fib_bridge_rx/u_xst_wrapper_0/socket_lvds_sys_slave_0/u_xst_wrapper_0/socket_lvds_gp_in_0/u_xst_wrapper_0/bufr_0/O}]
create_clock -name CLK_sys_idel_clk  -period 5.0                           [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_idly_0/bufg_0/O}]
create_clock -name CLK_fib_clk       -period 10.00           [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_bus_dut_0/fib_clk}]
create_clock -name CLK_fib_clk_hs    -period [expr 10.00/3]  [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_bus_dut_0/fib_clk_hs}]
create_clock -name CLK_srb_clk       -period [expr 10.00*10] [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_bus_dut_0/srb_clk}]
create_clock -name CLK_sys_xclk      -period 2.22                 [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk_0/sys_xclk}]
create_clock -name CLK_sys_xclk_dv4  -period [expr 2.22*4]        [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk_0/sys_xclk_dv4}]
create_clock -name CLK_sys_xclk2     -period 2.22                [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk2_0/sys_xclk2}]
create_clock -name CLK_sys_xclk2_dv4 -period [expr 2.22*4]       [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk2_0/sys_xclk2_dv4}]
#XDC=design_bufg.zdc
create_clock -name zebu_clock0 -period 50000.0 -waveform {25000.0 50000.0} [get_nets {design/part_NoSLR/U0_M0_F0/zcgen_w_zcg_filterClock}]
create_clock -name zebu_clock1 -period 100000.0 [get_nets {design/part_NoSLR/U0_M0_F0/zcgen_w_zcg_compositeClock}]
create_clock -name zebu_clock2 -period 100000.0 [get_nets {design/part_NoSLR/U0_M0_F0/zebu_zdly_z_dclk_delay_12524327392187371745}]
...
#XDC=design_fwc.zdc
add_cells_to_pblock SLR0 [get_cells {wc_ip_top/wrapper/fwc_ip_hs_cluster_32[0]}]


########## gen_clock :
#XDC=design_fw.zdc
#xdc_lib lib_zse_xc7v_8c_v1_xdc:f00_fx_macro
create_generated_clock -name CLK_sys_idel_clk_dv2 -divide_by 2 -source [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sys_idel_clk}] [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sys_idel_clk_dv2}]
create_generated_clock -name CLK_sys_idel_clk_dv4 -divide_by 4 -source [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sys_idel_clk}] [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sys_idel_clk_dv4}]
create_generated_clock -name CLK_sys_idel_clk_dv8 -divide_by 8 -source [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sys_idel_clk}] [get_pins {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sys_idel_clk_dv8}]
...
#XDC=design_fw.zdc
#xdc_lib lib_zse_xc7v_8c_v1_xdc:f00_fx_macro
set_clock_groups -asynchronous -name GRP_design_part_NoSLR_zkprctrl_wrapper_fib_bridge_rx_u_xst_wrapper_0_socket_lvds_sys_slave_0_u_xst_wrapper_0_socket_lvds_gp_in_0_u_xst_wrapper_0_clki_dv -group [get_clocks CLK_design_part_NoSLR_zkprctrl_wrapper_fib_bridge_rx_u_xst_wrapper_0_socket_lvds_sys_slave_0_u_xst_wrapper_0_socket_lvds_gp_in_0_u_xst_wrapper_0_clki_dv]
...
set_property LOC BUFGCTRL_X0Y36 [get_cells {design/part_NoSLR/U0_M0_F0/zbufg_zcgen_w_zcg_filterClock}]
set_property LOC BUFGCTRL_X0Y40 [get_cells {design/part_NoSLR/U0_M0_F0/zbufg_zcgen_w_zcg_compositeClock}]
set_property LOC BUFGCTRL_X0Y35 [get_cells {design/part_NoSLR/U0_M0_F0/zbufg_zebu_zdly_z_dclk_delay_12524327392187371745}]
#XDC=design_fw.zdc
#xdc_lib lib_zse_xc7v_8c_v1_xdc:f00_fx_macro
set_max_delay -from [get_pins {design/part_NoSLR/zkprctrl/wrapper/srb_bridge/srb_bridge_srb_0/srb_data_rd_buf_*/Q}] -to [get_clocks CLK_fib_clk] -datapath_only [expr 10.00*10]
set_max_delay -through [get_nets {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sock_ce[*]}]                 [expr 10.00*10]
set_max_delay -through [get_nets {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sock_sr[*]}]                 [expr 10.00*10]
set_max_delay -through [get_nets {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sock_clko_en[*]}]            [expr 10.00*10]
set_max_delay -through [get_nets {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk_0/bufgctrl_en}]  [expr 10.00*10]
set_max_delay -through [get_nets {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk2_0/bufgctrl_en}] [expr 10.00*10]
...
#XDC=design_fw.zdc
#xdc_lib lib_zse_xc7v_8c_xdc:f00_zpad_bus
set_false_path -through [get_pins design/part_NoSLR/zpad_bus_ins/zplwc_ip_out_wc_ip_stop_clock]
#xdc_lib lib_zse_xc7v_8c_xdc:f00_zpad_bus
set_false_path -through [get_pins design/part_SLR0/zpad_bus_ins/zplwc_ip_out_wc_ip_stop_clock]
...
#XDC=design_fw.zdc
#xdc_lib lib_zse_xc7v_8c_v1_xdc:f00_fx_macro
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets -top_net_of_hierarchical_group -segments {design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sys_xclk2_in}]
...
add_cells_to_pblock pblock_fxmacro [get_cells {design/part_NoSLR/zkprctrl/wrapper/fib* design/part_NoSLR/zkprctrl/wrapper/srb*}]
create_pblock pblock_fx_macro_slr
resize_pblock pblock_fx_macro_slr -add {CLOCKREGION_X0Y6:CLOCKREGION_X1Y8}
set_property LOC MMCME2_ADV_X0Y5 [get_cells design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk_0/series7_pll_xclk]   ; # SLR 1 Top    MMCM05
set_property LOC MMCME2_ADV_X0Y4 [get_cells design/part_NoSLR/zkprctrl/wrapper/sysclk_mxfx/u_xst_wrapper_0/sysclk_xclk2_0/series7_pll_xclk]  ; # SLR 1 Bottom MMCM04
#xdc_lib lib_zse_xc7v_8c_xdc:f00_zpad_bus
...
add_cells_to_pblock pblock_bk40 design/part_SLR3/socket_00_00_00_08/ClockRegion000SD_40B/ser0
